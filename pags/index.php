...
<head>
    ...
    <div id="asd">
        ...
        <div class="new_splash">
            <form>
                <input type="text" class="new_splash_input" placeholder="new_splash" autocomplete="off" />
            </form>
        </div>
            ...
            function randomSplash() {
                fetch('http://localhost/php/splashes.php')
                    ...
                    .then(response => {
                        ...
                        return response.json(); // parses the response as JSON to a JS object, as this is what the ajax request returns
                    })
                    .then(data => {
